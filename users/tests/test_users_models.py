...
class UserModelTest(TestCase):
    def setUp(self):
        self.user_data = {
            ...
            "academic_statuses": [
                {
                    "academic_email": "testuser@university.edu",
                    "start_year": 2020,
                    "end_year": 2024,
                }
            ],
...
class NotificationModelTest(TestCase):
    ...
    def test_create_notification(self):
        ...
        self.assertEqual(
            notification.notification_type, self.notification_data["notification_type"]
        )
...
class ReputationModelTest(TestCase):
    ...
    def test_add_reputation(self):
        ...
        self.assertEqual(
            ...
            Reputation.SUBMIT_ARTICLE + Reputation.CREATE_COMMUNITY,
        )
        self.assertEqual(self.reputation.level, "Novice")
        ...
        self.assertEqual(
            self.reputation.score,
            Reputation.SUBMIT_ARTICLE * 4 + Reputation.CREATE_COMMUNITY,
        )
        self.reputation.add_reputation("SUBMIT_ARTICLE")
        self.assertEqual(
            self.reputation.score,
            Reputation.SUBMIT_ARTICLE * 5 + Reputation.CREATE_COMMUNITY,
        )
    ...
    def test_str(self):
        self.assertEqual(
            str(self.reputation), f"{self.user.username} - Novice (0 points)"
        )
