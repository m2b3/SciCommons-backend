...
class Article(models.Model):
    ...
    authors = models.ManyToManyField('app.User', through="Author", related_name="article_authors")
    community = models.ManyToManyField('app.Community', through="app.CommunityMeta")
    views = models.IntegerField(default=0)
    doi = models.CharField(max_length=255, null=True, blank=True)

    reviewer = models.ManyToManyField("app.OfficialReviewer", through='ArticleReviewer',
    ...
    blocked_users = models.ManyToManyField('app.User', through='ArticleBlockedUser')
