...
class ArticleGetSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'article_name', 'article_file', 'Public_date', 'Code', 'Abstract', 'views', 'video', 'doi',
                  'published_article_file', 'link', 'authors', 'rating', 'versions', 'isArticleReviewer',
                  'isArticleModerator', 'isAuthor', 'status', 'isFavourite', 'userrating', 'commentcount',
                  'favourites', 'license', 'published_date', 'published', 'unregistered_authors']
