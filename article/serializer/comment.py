...
from article.models import CommentBase, HandlersBase, LikeBase, Author, ArticleReviewer, ArticleModerator, \
    ArticleBlockedUser
from community.models import OfficialReviewer, Moderator
from user.models import UserActivity, Notification, Rank
...
class CommentCreateSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if not handler:
            handler = HandlersBase.objects.create(User=instance.User, article=instance.article, handle_name=faker.name())
            handler.save()
