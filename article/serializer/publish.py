...
from community.models import CommunityMeta, CommunityMember, Community
    ...
    def create(self, validated_data):
        ...
        with transaction.atomic():
            for community in communities:
                ...
                community_meta = CommunityMeta.objects.create(
                ...
                send_mail(
                    "New Article Alerts",
                    f'New Article {instance.article_name} added on {community}',
